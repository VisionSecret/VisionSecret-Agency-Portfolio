...
const Page2 = () => {
  ...
  return (
    <>
      <div
        id="section2"
        className="bg-[#FAFAFA] h-fit overflow-y-hidden sm:overflow-y-auto overflow-x-hidden text-black p-4 sm:p-12 z-30"
      >
        <h3 className="animate-bounce text-[3.4vw] sm:text-lg text-center text-[#222] font-[anzo3]">
          © Ans.STUDIO 2024 to 2025 |{" "}
          {/* © vS.Agency 2024 to 2025 |{" "} */}
          <span className="font-semibold text-black">designed</span> and{" "}
          <span className="font-semibold text-black">developed</span>
        </h3>
        <div id="rotateText" className="mt-4 sm:mt-10">
          <h1 className="uppercase text-black text-center text-[36vw] leading-[35vw] font-[anzo2]">
            IMPACTFUL
          </h1>
        </div>
        <div id="rotateText">
          <h1 className="uppercase text-black text-center text-[30vw] leading-[35vw] font-[anzo2]">
            DEVELOPMENT
          </h1>
        </div>
        <div id="rotateText">
        ...
        <div className="w-full h-8 flex items-center justify-center sm:scale-75 mt-8">
          <svg
            preserveAspectRatio="xMidYMid meet"
            data-bbox="0 0 2028.339 83"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 2028.339 83"
            height="83"
            width="2029"
            data-type="color"
            role="img"
          ...
          >
            <defs>
              <style>
                {`
        #comp-lmynz5gu2 [data-color="1"] {
          fill: #060606; /* No quotes around the color */
        }
      `}
              </style>
            </defs>
            <g>
              ...
              <g clipPath="url(#6bf1528a-5060-4558-8229-fcf568fce101_comp-lmynz5gu2)">
                <mask
                  ...
                  id="797c2771-61a2-4bfc-909f-a6acae9cd61d_comp-lmynz5gu2"
                  fill="none"
                  style={{ maskType: "luminance" }} // Use object notation for inline styles
                >
                  <path
                    fill="#ffffff"
                    d="M911.657 19.798H799.585v43.39h112.072v-43.39Z"
                  />
                </mask>
                <g mask="url(#797c2771-61a2-4bfc-909f-a6acae9cd61d_comp-lmynz5gu2)">
                  <path
                    fill="#060606"
                    d="M911.658 19.798h-6.19c-1.718 0-3.323.85-4.287 2.272l-8.279 12.213a.556.556 0 0 1-.919 0l-8.279-12.213a5.177 5.177 0 0 0-4.287-2.272h-6.191l14.748 21.756-14.667 21.634h6.191c1.717 0 3.323-.85 4.287-2.273l8.198-12.091a.556.556 0 0 1 .919 0l8.197 12.091a5.177 5.177 0 0 0 4.287 2.273h6.191L896.91 41.553l14.748-21.755Z"
                    data-color="1"
                  ></path>
                  <path
                    fill="#060606"
                    d="M860.483 24.236v38.952h2.959a4.437 4.437 0 0 0 4.438-4.439V19.798h-2.958a4.438 4.438 0 0 0-4.439 4.438Z"
                    data-color="1"
                  ></path>
                  <path
                    fill="#060606"
        ...
        <div className="h-[1px] w-2/3 sm:w-1/4 bg-black relative left-1/2 -translate-x-1/2 sm:mt-7"></div>
      </div>
    </>
  );
};
