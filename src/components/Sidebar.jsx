...
const Sidebar = ({ setIsSidebar }) => {
  ...
  return (
    <div className="sidebar fixed top-3 right-0 w-full md:w-0 h-[96%] z-50 px-2 md:px-1 mr-5 overflow-x-hidden rounded-md bg-[#FAFAFA] shadow-lg transform transition-transform">
